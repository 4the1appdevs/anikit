...
(function(){
  var ldrsNodes, ldrs1, ldrs2, ldrs1Demo, kit, ldap, ldapNodes, threeInit, threePrepare, threeRoot, ref$, renderer, scene, camera, mesh, animate;
  ...
  threePrepare = function(root){
    var ref$, camera, scene, renderer, w, h, controls, animate, d, shape, geom, mat, mesh, group, light;
    ref$ = threeInit(root), camera = ref$.camera, scene = ref$.scene, renderer = ref$.renderer, w = ref$.w, h = ref$.h, controls = ref$.controls, animate = ref$.animate;
    d = 1.1;
  ...
  ref$ = threePrepare(threeRoot), renderer = ref$.renderer, scene = ref$.scene, camera = ref$.camera, mesh = ref$.mesh, animate = ref$.animate;
  ldrs2.on('change', function(it){
  ...
  return function(){
    ...
    f = function(t){
      ...
      if (local.kit) {
        local.kit.animateThree(local.mesh, t);
        local.renderer.render(local.scene, local.camera);
        local.kit.animateJs(local.jsObj, t);
      }
        ...
        "compare-btn": function(arg$){
          ...
          return node.addEventListener('click', function(){
            return ldap.get({
              ...
              delete local.start;
              return view.getAll('css').map(function(d, i){
                var delay;
                delay = i / ldapNodes.length;
                if (!k.config.repeat) {
                  delay = -1 + delay;
    ...
    local.jsObj = view.get('js');
    return import$(local, threePrepare(view.get('webgl')));
  }();
})();
