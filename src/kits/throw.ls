(->
  ...
  ret = do
    ...
    type: \animation
    preset: do
      "throw-ttb-in": label: "throw-in (top to bottom)", dir: 2, repeat: 1
      "throw-ltr-in": label: "throw-in (left to right)", dir: 4, repeat: 1
      "throw-rtl-in": label: "throw-in (right to left)", dir: 3, repeat: 1
      "throw-btt-in": label: "throw-in (bottom to top)", dir: 1, repeat: 1
